# mcp2cli — Claude Code Instructions
...
```bash
# Run full test suite (96 tests covering OpenAPI, MCP stdio, MCP HTTP, caching, token savings)
uv run pytest tests/ -v

# Run a specific test file
uv run pytest tests/test_openapi.py -v

# Run token savings tests with output
